...
// Define the toast props interface
export interface ToastComponentProps extends Omit<ToastPrimitiveProps, 'title'> {
  id: string;
...
export interface ToastContextType {
  ...
  toast: (props: Omit<ToastComponentProps, 'id'>) => { id: string };
...
const ToastContext = React.createContext<ToastContextType>(defaultToastContext);
